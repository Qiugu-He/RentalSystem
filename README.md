...
- **API testing: GET**
<img src="https://github.com/Qiugu-He/RentalSystem/blob/master/GET.png" alt="alt text" width="80%" height="80%">

- **API testing: POST**
<img src="https://github.com/Qiugu-He/RentalSystem/blob/master/PUT.png" alt="alt text" width="80%" height="80%">

- **API testing: Delete**
<img src="https://github.com/Qiugu-He/RentalSystem/blob/master/Delete.png" alt="alt text" width="80%" height="80%">
